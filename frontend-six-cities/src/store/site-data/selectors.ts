...
export const getOffers = ({ [StoreSlice.SiteData]: SITE_DATA }: State): Offer[] =>
  SITE_DATA.offers;
...
export const getOffer = ({ [StoreSlice.SiteData]: SITE_DATA }: State): Offer | null =>
  SITE_DATA.offer;

export const getPremiumOffers = ({ [StoreSlice.SiteData]: SITE_DATA }: State): Offer[] =>
  SITE_DATA.premiumOffers;
export const getComments = ({ [StoreSlice.SiteData]: SITE_DATA }: State): Comment[] =>
  SITE_DATA.comments;
